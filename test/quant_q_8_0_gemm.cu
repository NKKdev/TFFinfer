...
//         int32_t *a_k_data = reinterpret_cast<int32_t *>(a_reg.qs);
//         float d_a = __half2float(a_reg.d);
//         int32_t *b_k_data = reinterpret_cast<int32_t *>(b_reg.qs);
...
//         __syncthreads();
//
//         compute_tile<QUANT_BLOCK_SIZE>(thread_x, thread_y, &a_sm[0][0], &b_sm[0][0], c_reg);
//         __syncthreads();
//     }
//
