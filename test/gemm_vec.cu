...
//             }
//             sm[(thread_x + kk * BLOCK_DIM_K / VEC_DIM_K) * (BLOCK_DIM_LD + PAD_SIZE) + thread_y
...
// #pragma unroll
//     for (int j = 0; j < VEC_DIM_LD; j++) {
//         int dim0_base = start_block + thread_y + j * BLOCK_DIM_LD / VEC_DIM_LD;
//         for (int kk = 0; kk < VEC_DIM_K / ELEMENTS_PER_LOAD; kk++) {
//             int dim1 = k + thread_x * ELEMENTS_PER_LOAD + kk * (BLOCK_DIM_K / VEC_DIM_K) * ELEMENTS_PER_LOAD;
//             T val[ELEMENTS_PER_LOAD] = {0};
//             if (dim0_base < dim) {
...
// #pragma unroll
//             for (int i = 0; i < ELEMENTS_PER_LOAD; ++i) {
//                 sm[(thread_x * ELEMENTS_PER_LOAD + kk * (BLOCK_DIM_K / VEC_DIM_K) * ELEMENTS_PER_LOAD + i) * (BLOCK_DIM_LD + PAD_SIZE) + thread_y
...
// }
//
// int main123444(int argc, char *argv) {
